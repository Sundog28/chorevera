  ...
  return (
    <>
      <div className="legal-heading">
        ...
        <h1>ChoreFlow Privacy Policy</h1>
        <p>Effective {EFFECTIVE_DATE}</p>
      </div>

      <section>
        <h2>1. Overview</h2>
        <p>ChoreFlow is a household chore management service. This policy explains the information ChoreFlow collects, why it is used, and the choices available to you.</p>
      </section>
      ...
      <section>
        <h2>3. Payments</h2>
        <p>Payments are processed by Stripe. ChoreFlow does not store your full payment-card number or card security code. Stripe may collect and process payment and identity information under its own privacy terms.</p>
      </section>

      <section>
        <h2>4. Email delivery</h2>
        <p>ChoreFlow uses an email service provider to deliver account verification, password-reset, and service-related messages. Information needed to send those messages may be processed by that provider.</p>
      </section>

      <section>
        <h2>5. How we use information</h2>
        <ul>
          <li>Create, authenticate, and protect ChoreFlow accounts.</li>
      ...
      <section>
        ...
        <p>ChoreFlow may use browser storage to maintain your authenticated session, preserve interface state, and cache limited application information. Browser notifications are used only after you grant notification permission.</p>
      </section>
      ...
      <section>
        <h2>9. Security</h2>
        <p>ChoreFlow uses technical and organizational safeguards intended to protect account information, including protected password storage, authenticated API access, transport encryption, access controls, security logging, and managed infrastructure. No online service can guarantee absolute security.</p>
      </section>

      <section>
        <h2>10. Children</h2>
        <p>ChoreFlow is not directed to children under 13, and children under 13 should not create ChoreFlow accounts. A parent or guardian may manage household chores for family members without creating an account for a child under 13.</p>
      </section>

      <section>
        <h2>11. Your choices and requests</h2>
        <p>You may request access, correction, or deletion of your account information, subject to applicable law and records ChoreFlow must retain. You can also manage subscription status through ChoreFlow billing tools.</p>
      </section>

      <section>
        <h2>12. Changes to this policy</h2>
        <p>We may update this policy as ChoreFlow changes. The effective date at the top of this page identifies the current version.</p>
      </section>
  ...
  return (
    <>
      <div className="legal-heading">
        ...
        <h1>ChoreFlow Terms of Service</h1>
        <p>Effective {EFFECTIVE_DATE}</p>
      </div>

      <section><h2>1. Agreement</h2><p>By creating an account or using ChoreFlow, you agree to these Terms of Service. If you do not agree, do not use the service.</p></section>
      <section><h2>2. Eligibility</h2><p>You must be at least 13 years old to create a ChoreFlow account. If you are under the age of majority where you live, you should use ChoreFlow only with permission from a parent or legal guardian.</p></section>
      <section><h2>3. Accounts</h2><p>You are responsible for providing accurate account information, maintaining the confidentiality of your credentials, and activities performed through your account. Notify ChoreFlow promptly if you believe your account has been compromised.</p></section>
...
function SupportPage() {
  return (
    <>
      ...
      <section><h2>Password and login help</h2><p>Use the <strong>Forgot password</strong> option on the ChoreFlow sign-in page to request a secure password-reset link. New accounts must verify their email before signing in.</p></section>
      <section><h2>Billing help</h2><p>Signed-in users can use ChoreFlow's billing controls to open the Stripe customer portal, manage payment details, and cancel an active subscription.</p></section>
      <section><h2>Security concerns</h2><p>If you believe your account or ChoreFlow may have a security problem, contact support promptly and include the affected account email, approximate time of the issue, and a description of what you observed. Do not include passwords or secret keys.</p></section>
      <section><h2>Service status</h2><p>During the public beta, maintenance or hosting-provider incidents may temporarily affect ChoreFlow. If the app appears unavailable, try again after a short interval and contact support if the problem continues.</p></section>
    </>
  );
}
  ...
  return (
    <div className="legal-site-shell">
      <header className="legal-topbar">
        <a aria-label="Return to ChoreFlow" className="legal-brand" href="/">
